  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a]">
      <div className="max-w-3xl mx-auto px-6 py-20 md:py-28">
        <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-[#f5f5f0] mb-4" data-aos="fade-up">
        ...
        <p className="text-gray-600 dark:text-[#999999] text-lg mb-10 leading-relaxed" data-aos="fade-up" data-aos-delay="100">
        ...
        <ul className="space-y-8 mb-12">
          {CHECKLIST.map((block, i) => (
            <li key={block.title} data-aos="fade-up" data-aos-delay={100 + i * 50}>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-[#f5f5f0] mb-3">{block.title}</h3>
              <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-[#999999]">
        ...
        <p className="text-gray-600 dark:text-[#999999] text-lg leading-relaxed mb-10" data-aos="fade-up">
