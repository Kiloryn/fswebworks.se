    ...
    <footer className="bg-gray-50 dark:bg-[#0a0a0a] border-t border-gray-200 dark:border-[#2a2a2a] py-16">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-12">
            ...
            <Link href="/" className="inline-block mb-4" aria-label="FSwebworks startsida">
              ...
              >
                ...
                <g fill="#c8a46e">
                  ...
                  <path d="M887.99,454.17l-26.09,25.78c-.38.38-.82.57-1.3.57-.31,0-.56-.09-.73-.26l-.1-.1c-.31-.31-.47-.66-.47-1.04,0-.42.17-.8.52-1.15l24.74-24.43-24.74-24.43c-.35-.35-.52-.73-.52-1.15,0-.38.16-.73.47-1.04l.1-.1c.17-.17.42-.26.73-.26.49,0,.92.19,1.3.57l26.09,25.78c.24.24.37.45.37.62s-.12.38-.37.62Z" />
                </g>
              </svg>
            </Link>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-gray-900 dark:text-[#f5f5f0] font-semibold mb-4">Länkar</h3>
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-gray-900 dark:text-[#f5f5f0] font-semibold mb-4">Kontakt</h3>
            <ul className="space-y-3">
              <li className="text-gray-500 dark:text-[#666666] text-sm">
                Stockholm, Sverige
              </li>
              <li>
                <a href="mailto:fredrik@fswebworks.se" className="text-gray-500 dark:text-[#666666] hover:text-[#c8a46e] text-sm">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-[#2a2a2a]">
          <p className="text-gray-500 dark:text-[#666666] text-sm text-center">
