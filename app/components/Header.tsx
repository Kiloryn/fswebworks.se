    ...
    <>
      ...
      >
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex items-center justify-between overflow-hidden h-14">
            {/* Logo – same size always (ScrollRevealFallback size); no layout change when it runs */}
            <Link
              href="/"
